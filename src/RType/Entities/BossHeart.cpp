...
namespace rtype::entities {
    BossHeart::BossHeart(ecs::ComponentManager &componentManager, ecs::EntityManager &entityManager, components::Position
    pos, components::NetId netId) : AEntity(entityManager){
        components::Size size = {256, 142};
        pos.x = 780;
        ...
        componentManager.addComponent<components::IA>(_id, {move, models::BOSS_HEART, 0.4, 1.0}, entityManager);
#ifdef RTYPE_IS_CLIENT
        components::Sprite sprite;
        sprite.priority = { 1 };

        sprite.sprite = std::make_shared<sf::Sprite>();
        sprite.texture = TextureManager::getInstance().getTexture("boss_heart");
        ...
        BossTurret::createTurret(_id, componentManager, entityManager, {pos.x - 60, pos.y - 70}, 0.6);
        BossTurret::createTurret(_id, componentManager, entityManager, {pos.x - 30, pos.y}, 0.45);
        BossTurret::createTurret(_id, componentManager, entityManager, {pos.x - 60, pos.y + 70}, 0.6);
#endif
    }
